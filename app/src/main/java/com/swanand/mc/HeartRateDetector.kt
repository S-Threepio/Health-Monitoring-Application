...
//    private class HeartRate : AsyncTask<Uri, Float, Int>() {
...
//            heartRateText.text = result.toString()
//            Toast.makeText(requireContext(), "Heart Rate: $result", Toast.LENGTH_SHORT).show()
//            bundle.putFloat("Heart Rate", result.toFloat())
//        }
//    }
//
